...
public static void main(String[] args) throws Exception {
    ...
    Complex d = new Complex(x,y);
        ...
        System.out.print("クラスを使ってプログラムを書くことで、複数のデータをひとまとめのオブジェクトにして投影することができる。ある型を作ってそこにデータを入れる、と考えるのでmainクラスがよりコンパクトにかくことができるのは大きな利点だと感じた。また、privateをすべてのデータの宣言につけることで、重要なデータを入れる公にすることなく秘匿できるのはセキュリティ上で様々なことに役立つと思った。最後に、ある、名前から分かりやすい変数を作った時にその名前のまま使いたいときにthis.を付ければいいというのは有用だと思った。");
    }
}
